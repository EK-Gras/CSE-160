...
class Vector3 {
    ...
    static dot(other1, other2) {
        var d = ((other1.elements[0] * other2.elements[0]) + (other1.elements[1] * other2.elements[1]) + (other1.elements[2] * other2.elements[2]))
        return d;
    }
    ...
    /**
      ...
      */
    magnitude() {
        var m = Math.sqrt((this.elements[0] ** 2) + (this.elements[1] ** 2) + (this.elements[2] ** 2));
        return m;
    };
